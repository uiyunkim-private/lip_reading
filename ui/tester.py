...
import time
import os
from environment.variable import DATASET_DIR,ROOT_DIR,MODEL_DIR,CONFIG_PATH
...
class Tester:
    ...
    def predict(self):
        ...
        for image in self.recorded_frames:
            face = facecropper(image, self.face_shape, self.face_detector, self.face_predictor)
